            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- 회원 정보 수정 폼 -->
                        ...
                        <form action = "user_update.php" class="form-signin" style="max-width:500px;  margin: 0 auto;" th:action="@{/account/myinfo}" method="post" th:object="${member}">

                            <div class="mb-3">
                                <label th:for="nickname">비밀번호</label>
                                <input type="password" placeholder = '비밀번호 변경' class="form-control" th:field="*{nickname}">                               
                            </div>

                            <div class="mb-3">
                                <label th:for="name">이름</label>
                                <input type="text" placeholder = '사용자 이름 변경' class="form-control" th:field="*{nickname}">                               
                            </div>

                            <div class="mb-3">
                                <label th:for="username">Email</label>
                                <input type="email" placeholder = '이메일 입력'  class="form-control">
                            </div>                      

                            <div class="mb-3">
                                <label for="tel">전화번호</label>
                                <input type="tel" placeholder = '전화번호 입력'  class="form-control" id="phonenumber" th:readonly="readonly">
                            </div>

                            <div class="mb-3">
                                <label for="address">주소</label>
                                <input type="address" placeholder = '주소 변경' class="form-control" id="address" th:readonly="readonly">
                            </div>

                            <div class="mb-3">
                                <button class="w-100 btn btn-lg btn-primary" type="submit"
                                    onclick="return modifyCheckAll()">수정</button>
                            </div>
